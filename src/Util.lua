...
function GnerateQuadBackward(atlas)
    return love.graphics.newQuad(0, 250, 50, 50, atlas:getDimensions())
end

--[[
    forward icon
]]
function GnerateQuadForward(atlas)
    return love.graphics.newQuad(350, 350, 50, 50, atlas:getDimensions())
end
...
function generatePoleQuads(atlas)
    poles = {}
    for x = 0, 5 do
        poles[x+1] = love.graphics.newQuad(x * 16, 0, 16, 52, atlas:getDimensions())
    end
    for y = 6, 9 do
        poles[y+1] = love.graphics.newQuad(96, (y - 6) * 16, 16, 16, atlas:getDimensions())
    end
    return poles
end